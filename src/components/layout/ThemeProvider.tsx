...
export default function ThemeProvider({ children, themeValues }: ThemeProviderProps) {
  ...
  useEffect(() => {
    ...
    if (themeValues['background-color'])
      setVar('--background-light', themeValues['background-color'])
