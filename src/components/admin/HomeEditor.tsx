        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-8 rounded-lg border bg-white p-6 shadow-sm dark:bg-gray-800">
            ...
            <div className="grid gap-6 md:grid-cols-2">
                ...
                <div className="space-y-4">
                    <h3 className="text-sm font-bold uppercase tracking-wider text-gray-500">Columna Izquierda (Títulos)</h3>
                ...
                {/* Right Column Config */}
                <div className="space-y-4">
                    <h3 className="text-sm font-bold uppercase tracking-wider text-gray-500">Columna Derecha (Imagen Principal)</h3>
            ...
            <div className="border-t pt-6">
                ...
                <div className="flex items-center gap-4">
                    ...
                    />
                    <label htmlFor="showFeat" className="font-medium">Mostrar Sección Destacados</label>
                </div>
