...
const tutorials: TutorialSection[] = [
  ...
  },
  {
    id: 'analitica',
    icon: '📊',
    title: 'Estadísticas y Analítica',
    description: 'Comprende el comportamiento de tus visitantes',
    steps: [
      'Ve a "Analítica" en el menú lateral',
      'El dashboard muestra las métricas clave de los últimos 30 días',
      'Visualiza qué proyectos son los más vistos (ranking top 5)',
      'Revisa el gráfico de visitas por día para detectar picos de tráfico',
      'Consulta la tasa de conversión (visitas vs contactos enviados)',
    ],
    tips: [
      '"Visitas Totales" cuenta cada vez que alguien accede a una página (incluye recargas)',
      '"Proyectos Vistos" son las veces que se abrió el detalle de un trabajo específico',
      '"Leads" son los mensajes recibidos a través del formulario de contacto',
      'Los datos se actualizan en tiempo real (no necesitas recargar la página)',
      'Si integras Google Analytics (Fase 4), tendrás datos demográficos adicionales',
    ],
  },
  {
    id: 'contactos',
  ...
  },
  {
    ...
    steps: [
      ...
      'Crea un nuevo testimonio con nombre, texto y calificación (1-5 estrellas)',
      'Opcionalmente, sube una foto del cliente o usa un avatar placeholder',
      'Marca como "Activo" para que se muestre en la página principal (slider)',
      'Los testimonios inactivos se guardan pero no son visibles al público',
      'Edita o elimina testimonios desde la lista',
    ],
    tips: [
      'Pide permiso al cliente antes de publicar su foto y opinión (GDPR)',
      'Los testimonios con 5 estrellas tienen mayor impacto visual',
      'Alterna entre testimonios de diferentes tipos de servicio (novia, editorial, etc.)',
  ...
  },
  {
    ...
    description: 'Personaliza colores y textos del portfolio',
    steps: [
      'Ve a "Configuración" en el menú lateral',
      'Modifica los colores principales: fondo, texto principal y color de acento',
      'Actualiza el texto de la sección "Sobre Mí"',
      'Sube una imagen de hero/banner principal',
      'Guarda los cambios para aplicarlos globalmente',
    ],
    tips: [
      'Los cambios se aplican instantáneamente sin necesidad de recargar',
      'Usa colores con buen contraste para accesibilidad (WCAG AA mínimo)',
      'Puedes revertir al tema por defecto (wine/pink) en cualquier momento',
    ],
  },
]
