...
export default function AdminSobreMi() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      await presentationService.update({ title, content: aboutMe, imageUrl: profileImageUrl });
      setSuccessMessage("Información actualizada correctamente");
      toast({ title: "Guardado", description: "Se actualizó la información de Sobre Mí." });
    } catch (error) {
