...
export default function TestimonyLoading() {
  return (
    <section className="public-testimonial-page public-loading-page min-h-[70dvh] py-16 transition-colors duration-500">
      <div className="mx-auto max-w-lg px-6">
        ...
        <div className="mb-16">
          ...
          {/* Form card */}
          <div className="public-testimonial-form-panel flex flex-col gap-5 rounded-2xl border p-8 shadow-md">
            {/* Name */}
        ...
        <div className="public-testimonial-section border-t pt-16">
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            {Array.from({ length: 4 }).map((_, i) => (
              <div key={i} className="public-testimonial-card flex flex-col rounded-2xl border p-5">
