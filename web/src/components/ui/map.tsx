...
const MAP_DEFAULT_ROUTE_COLOR = STATUS_COLORS.info
const MAP_DEFAULT_CLUSTER_COLORS: [string, string, string] = [
  STATUS_COLORS.success,
  STATUS_COLORS.warning,
  STATUS_COLORS.danger,
]
const MAP_DEFAULT_POINT_COLOR = STATUS_COLORS.info
const MAP_CONTRAST_STROKE = NEUTRAL.white
...
type MapArcProps<T extends MapArcDatum = MapArcDatum> = {
   ...
   * defaults (`line-color` = info, `line-width: 2`, `line-opacity: 0.85`).
...
const DEFAULT_ARC_PAINT: MapArcLinePaint = {
  'line-color': MAP_DEFAULT_ROUTE_COLOR,
  'line-width': 2,
  'line-opacity': 0.85,
}
...
type MapClusterLayerProps<P extends GeoJSON.GeoJsonProperties = GeoJSON.GeoJsonProperties> = {
  ...
  /** Colors for cluster circles: [small, medium, large] (default: success / warning / danger). */
  clusterColors?: [string, string, string]
  /** Point count thresholds for color/size steps: [medium, large] (default: [100, 750]) */
  clusterThresholds?: [number, number]
  /** Color for unclustered individual points (default: info). */
  pointColor?: string
...
function MapClusterLayer<P extends GeoJSON.GeoJsonProperties = GeoJSON.GeoJsonProperties>({
  ...
  clusterMaxZoom = 14,
  clusterRadius = 50,
  clusterColors = MAP_DEFAULT_CLUSTER_COLORS,
  clusterThresholds = [100, 750],
  pointColor = MAP_DEFAULT_POINT_COLOR,
  onPointClick,
  onClusterClick,
  ...
  useEffect(() => {
    ...
    map.addLayer({
      ...
      paint: {
        ...
        'circle-stroke-color': MAP_CONTRAST_STROKE,
        'circle-opacity': 0.85,
      },
    })
    ...
    map.addLayer({
      ...
      paint: {
        'text-color': MAP_CONTRAST_STROKE,
      },
    })
