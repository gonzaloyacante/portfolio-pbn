...
export function SkeletonTestimonialsPage() {
  return (
    <div className="mx-auto max-w-5xl space-y-8">
      <SkeletonPageHeader />
      <div className="bg-card rounded-card space-y-4 border p-6 shadow-sm">
...
export function SkeletonSettingsPage() {
  return (
    <div className="mx-auto max-w-3xl space-y-8">
      <SkeletonPageHeader />
      {[1, 2].map((i) => (
        <div key={i} className="bg-card rounded-card space-y-4 border p-6 shadow-sm">
          <Skeleton className="h-5 w-40 rounded" />
...
export function SkeletonFormPage() {
  return (
    <div className="mx-auto max-w-3xl space-y-8">
      <SkeletonPageHeader />
      <div className="bg-card rounded-card space-y-5 border p-6 shadow-sm">
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          <Skeleton className="h-10 w-full rounded-xl" />
          <Skeleton className="h-10 w-full rounded-xl" />
        </div>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div className="space-y-4">
          {Array.from({ length: 4 }).map((_, i) => (
            <div key={i} className="bg-card rounded-card space-y-2 border p-4 shadow-sm">
