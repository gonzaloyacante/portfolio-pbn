...
- **Majors pendientes** (constreñidas a major actual, breaking changes): device_info_plus ^10 (→13), flutter_local_notifications ^20 (→22), image_cropper ^11 (→12), permission_handler ^11 (→12). Sin CVE; deuda de mantenimiento. Bump escalonado + regen freezed/json. Dejar para sesión dedicada.
