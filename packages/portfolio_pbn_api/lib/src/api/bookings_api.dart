...
class BookingsApi {
  ...
  Future<Response<Booking>> createBooking({ 
    ...
    final _path = r'/api/admin/bookings';
    ...
    try {
_bodyData=jsonEncode(createBookingRequest);
...
_responseData = rawData == null ? null : deserialize<Booking, Booking>(rawData, 'Booking', growable: true);
    } catch (error, stackTrace) {
      throw DioException(
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<DeleteResponse>> deleteBooking({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/admin/bookings/{id}'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<DeleteResponse, DeleteResponse>(rawData, 'DeleteResponse', growable: true);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
  ...
  /// Returns a [Future] containing a [Response] with a [Booking] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Booking>> getBooking({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
...
_responseData = rawData == null ? null : deserialize<Booking, Booking>(rawData, 'Booking', growable: true);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BookingList>> listBookings({ 
    String? status,
    int? page,
    int? limit,
    CancelToken? cancelToken,
    ...
    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<BookingList, BookingList>(rawData, 'BookingList', growable: true);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
  ...
  Future<Response<Booking>> updateBooking({ 
    ...
    try {
_bodyData=jsonEncode(updateBookingRequest);
    } catch(error, stackTrace) {
      throw DioException(
         requestOptions: _options.compose(
          _dio.options,
