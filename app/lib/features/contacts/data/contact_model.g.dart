...
Map<String, dynamic> _$ContactItemToJson(_ContactItem instance) => <String, dynamic>{
  'id': instance.id,
  'name': instance.name,
...
_ContactDetail _$ContactDetailFromJson(Map<String, dynamic> json) => _ContactDetail(
  id: json['id'] as String,
  name: json['name'] as String,
  email: json['email'] as String,
  phone: json['phone'] as String?,
...
Map<String, dynamic> _$ContactDetailToJson(_ContactDetail instance) => <String, dynamic>{
  'id': instance.id,
  'name': instance.name,
  'email': instance.email,
  'phone': instance.phone,
