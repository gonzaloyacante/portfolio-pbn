...
_BookingService _$BookingServiceFromJson(Map<String, dynamic> json) => _BookingService(name: json['name'] as String);

Map<String, dynamic> _$BookingServiceToJson(_BookingService instance) => <String, dynamic>{'name': instance.name};
...
_BookingItem _$BookingItemFromJson(Map<String, dynamic> json) => _BookingItem(
  ...
  service: json['service'] == null ? null : BookingService.fromJson(json['service'] as Map<String, dynamic>),
  createdAt: DateTime.parse(json['createdAt'] as String),
  updatedAt: DateTime.parse(json['updatedAt'] as String),
);

Map<String, dynamic> _$BookingItemToJson(_BookingItem instance) => <String, dynamic>{
  'id': instance.id,
...
_BookingDetail _$BookingDetailFromJson(Map<String, dynamic> json) => _BookingDetail(
  id: json['id'] as String,
  date: DateTime.parse(json['date'] as String),
  endDate: json['endDate'] == null ? null : DateTime.parse(json['endDate'] as String),
  status: json['status'] as String? ?? 'PENDING',
  ...
  reminderSentAt: json['reminderSentAt'] == null ? null : DateTime.parse(json['reminderSentAt'] as String),
...
Map<String, dynamic> _$BookingDetailToJson(_BookingDetail instance) => <String, dynamic>{
  'id': instance.id,
  'date': instance.date.toIso8601String(),
  'endDate': instance.endDate?.toIso8601String(),
  'status': instance.status,
