...
mixin _$TestimonialItem {
 ...
 String get id; String get name; String? get excerpt; String? get position; String? get company; String? get avatarUrl; int get rating; bool get verified; bool get featured; String get status; bool get isActive; int get sortOrder; DateTime get createdAt; DateTime get updatedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,excerpt,position,company,avatarUrl,rating,verified,featured,status,isActive,sortOrder,createdAt,updatedAt);

@override
String toString() {
  return 'TestimonialItem(id: $id, name: $name, excerpt: $excerpt, position: $position, company: $company, avatarUrl: $avatarUrl, rating: $rating, verified: $verified, featured: $featured, status: $status, isActive: $isActive, sortOrder: $sortOrder, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String id, String name, String? excerpt, String? position, String? company, String? avatarUrl, int rating, bool verified, bool featured, String status, bool isActive, int sortOrder, DateTime createdAt, DateTime updatedAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String? excerpt,  String? position,  String? company,  String? avatarUrl,  int rating,  bool verified,  bool featured,  String status,  bool isActive,  int sortOrder,  DateTime createdAt,  DateTime updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TestimonialItem() when $default != null:
return $default(_that.id,_that.name,_that.excerpt,_that.position,_that.company,_that.avatarUrl,_that.rating,_that.verified,_that.featured,_that.status,_that.isActive,_that.sortOrder,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String? excerpt,  String? position,  String? company,  String? avatarUrl,  int rating,  bool verified,  bool featured,  String status,  bool isActive,  int sortOrder,  DateTime createdAt,  DateTime updatedAt)  $default,) {final _that = this;
switch (_that) {
case _TestimonialItem():
return $default(_that.id,_that.name,_that.excerpt,_that.position,_that.company,_that.avatarUrl,_that.rating,_that.verified,_that.featured,_that.status,_that.isActive,_that.sortOrder,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
class _TestimonialItem implements TestimonialItem {
  const _TestimonialItem({required this.id, required this.name, this.excerpt, this.position, this.company, this.avatarUrl, this.rating = 5, this.verified = false, this.featured = false, this.status = 'PENDING', this.isActive = true, this.sortOrder = 0, required this.createdAt, required this.updatedAt});
