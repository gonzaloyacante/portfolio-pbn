...
Map<String, dynamic> _$ServiceItemToJson(_ServiceItem instance) => <String, dynamic>{
  'id': instance.id,
  'name': instance.name,
  'slug': instance.slug,
...
_ServiceDetail _$ServiceDetailFromJson(Map<String, dynamic> json) => _ServiceDetail(
  id: json['id'] as String,
  name: json['name'] as String,
  slug: json['slug'] as String,
...
Map<String, dynamic> _$ServiceDetailToJson(_ServiceDetail instance) => <String, dynamic>{
  'id': instance.id,
  'name': instance.name,
  'slug': instance.slug,
