...
/// @nodoc
mixin _$ServicePricingTierItem {

 String get id; String get name; String get price; String? get description; int get sortOrder;
/// Create a copy of ServicePricingTierItem
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$ServicePricingTierItemCopyWith<ServicePricingTierItem> get copyWith => _$ServicePricingTierItemCopyWithImpl<ServicePricingTierItem>(this as ServicePricingTierItem, _$identity);

  /// Serializes this ServicePricingTierItem to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ServicePricingTierItem&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.price, price) || other.price == price)&&(identical(other.description, description) || other.description == description)&&(identical(other.sortOrder, sortOrder) || other.sortOrder == sortOrder));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,price,description,sortOrder);

@override
String toString() {
  return 'ServicePricingTierItem(id: $id, name: $name, price: $price, description: $description, sortOrder: $sortOrder)';
}
...
/// @nodoc
abstract mixin class $ServicePricingTierItemCopyWith<$Res>  {
  factory $ServicePricingTierItemCopyWith(ServicePricingTierItem value, $Res Function(ServicePricingTierItem) _then) = _$ServicePricingTierItemCopyWithImpl;
@useResult
$Res call({
 String id, String name, String price, String? description, int sortOrder
});
...
/// @nodoc
class _$ServicePricingTierItemCopyWithImpl<$Res>
    implements $ServicePricingTierItemCopyWith<$Res> {
  _$ServicePricingTierItemCopyWithImpl(this._self, this._then);

  final ServicePricingTierItem _self;
  final $Res Function(ServicePricingTierItem) _then;

/// Create a copy of ServicePricingTierItem
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? price = null,Object? description = freezed,Object? sortOrder = null,}) {
...
/// Adds pattern-matching-related methods to [ServicePricingTierItem].
extension ServicePricingTierItemPatterns on ServicePricingTierItem {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ServicePricingTierItem value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _ServicePricingTierItem() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ServicePricingTierItem value)  $default,){
final _that = this;
switch (_that) {
case _ServicePricingTierItem():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ServicePricingTierItem value)?  $default,){
final _that = this;
switch (_that) {
case _ServicePricingTierItem() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String price,  String? description,  int sortOrder)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ServicePricingTierItem() when $default != null:
return $default(_that.id,_that.name,_that.price,_that.description,_that.sortOrder);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String price,  String? description,  int sortOrder)  $default,) {final _that = this;
switch (_that) {
case _ServicePricingTierItem():
return $default(_that.id,_that.name,_that.price,_that.description,_that.sortOrder);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  String price,  String? description,  int sortOrder)?  $default,) {final _that = this;
switch (_that) {
case _ServicePricingTierItem() when $default != null:
return $default(_that.id,_that.name,_that.price,_that.description,_that.sortOrder);case _:
  return null;
...
class _ServicePricingTierItem implements ServicePricingTierItem {
  const _ServicePricingTierItem({required this.id, required this.name, this.price = '', this.description, this.sortOrder = 0});
  factory _ServicePricingTierItem.fromJson(Map<String, dynamic> json) => _$ServicePricingTierItemFromJson(json);
...
@pragma('vm:prefer-inline')
_$ServicePricingTierItemCopyWith<_ServicePricingTierItem> get copyWith => __$ServicePricingTierItemCopyWithImpl<_ServicePricingTierItem>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$ServicePricingTierItemToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ServicePricingTierItem&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.price, price) || other.price == price)&&(identical(other.description, description) || other.description == description)&&(identical(other.sortOrder, sortOrder) || other.sortOrder == sortOrder));
}
...
/// @nodoc
abstract mixin class _$ServicePricingTierItemCopyWith<$Res> implements $ServicePricingTierItemCopyWith<$Res> {
  factory _$ServicePricingTierItemCopyWith(_ServicePricingTierItem value, $Res Function(_ServicePricingTierItem) _then) = __$ServicePricingTierItemCopyWithImpl;
@override @useResult
$Res call({
 String id, String name, String price, String? description, int sortOrder
});
...
/// @nodoc
class __$ServicePricingTierItemCopyWithImpl<$Res>
    implements _$ServicePricingTierItemCopyWith<$Res> {
  __$ServicePricingTierItemCopyWithImpl(this._self, this._then);

  final _ServicePricingTierItem _self;
  final $Res Function(_ServicePricingTierItem) _then;

/// Create a copy of ServicePricingTierItem
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? price = null,Object? description = freezed,Object? sortOrder = null,}) {
  return _then(_ServicePricingTierItem(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,name: null == name ? _self.name : name // ignore: cast_nullable_to_non_nullable
as String,price: null == price ? _self.price : price // ignore: cast_nullable_to_non_nullable
as String,description: freezed == description ? _self.description : description // ignore: cast_nullable_to_non_nullable
...
@useResult
$Res call({
 String id, String name, String slug, String? description, String? shortDesc, String? price, String? priceLabel, String currency, String? duration, int? durationMinutes, String? imageUrl, String? videoUrl, bool isActive, bool isFeatured, bool isAvailable, int? maxBookingsPerDay, int? advanceNoticeDays, int sortOrder, List<ServicePricingTierItem> pricingTiers, String? requirements, String? cancellationPolicy, String createdAt, String updatedAt
});
...
/// Create a copy of ServiceDetail
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? slug = null,Object? description = freezed,Object? shortDesc = freezed,Object? price = freezed,Object? priceLabel = freezed,Object? currency = null,Object? duration = freezed,Object? durationMinutes = freezed,Object? imageUrl = freezed,Object? videoUrl = freezed,Object? isActive = null,Object? isFeatured = null,Object? isAvailable = null,Object? maxBookingsPerDay = freezed,Object? advanceNoticeDays = freezed,Object? sortOrder = null,Object? pricingTiers = null,Object? requirements = freezed,Object? cancellationPolicy = freezed,Object? createdAt = null,Object? updatedAt = null,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,name: null == name ? _self.name : name // ignore: cast_nullable_to_non_nullable
as String,slug: null == slug ? _self.slug : slug // ignore: cast_nullable_to_non_nullable
...
as List<ServicePricingTierItem>,requirements: freezed == requirements ? _self.requirements : requirements // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String slug,  String? description,  String? shortDesc,  String? price,  String? priceLabel,  String currency,  String? duration,  int? durationMinutes,  String? imageUrl,  String? videoUrl,  bool isActive,  bool isFeatured,  bool isAvailable,  int? maxBookingsPerDay,  int? advanceNoticeDays,  int sortOrder,  List<ServicePricingTierItem> pricingTiers,  String? requirements,  String? cancellationPolicy,  String createdAt,  String updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ServiceDetail() when $default != null:
return $default(_that.id,_that.name,_that.slug,_that.description,_that.shortDesc,_that.price,_that.priceLabel,_that.currency,_that.duration,_that.durationMinutes,_that.imageUrl,_that.videoUrl,_that.isActive,_that.isFeatured,_that.isAvailable,_that.maxBookingsPerDay,_that.advanceNoticeDays,_that.sortOrder,_that.pricingTiers,_that.requirements,_that.cancellationPolicy,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String slug,  String? description,  String? shortDesc,  String? price,  String? priceLabel,  String currency,  String? duration,  int? durationMinutes,  String? imageUrl,  String? videoUrl,  bool isActive,  bool isFeatured,  bool isAvailable,  int? maxBookingsPerDay,  int? advanceNoticeDays,  int sortOrder,  List<ServicePricingTierItem> pricingTiers,  String? requirements,  String? cancellationPolicy,  String createdAt,  String updatedAt)  $default,) {final _that = this;
switch (_that) {
case _ServiceDetail():
return $default(_that.id,_that.name,_that.slug,_that.description,_that.shortDesc,_that.price,_that.priceLabel,_that.currency,_that.duration,_that.durationMinutes,_that.imageUrl,_that.videoUrl,_that.isActive,_that.isFeatured,_that.isAvailable,_that.maxBookingsPerDay,_that.advanceNoticeDays,_that.sortOrder,_that.pricingTiers,_that.requirements,_that.cancellationPolicy,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  String slug,  String? description,  String? shortDesc,  String? price,  String? priceLabel,  String currency,  String? duration,  int? durationMinutes,  String? imageUrl,  String? videoUrl,  bool isActive,  bool isFeatured,  bool isAvailable,  int? maxBookingsPerDay,  int? advanceNoticeDays,  int sortOrder,  List<ServicePricingTierItem> pricingTiers,  String? requirements,  String? cancellationPolicy,  String createdAt,  String updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _ServiceDetail() when $default != null:
return $default(_that.id,_that.name,_that.slug,_that.description,_that.shortDesc,_that.price,_that.priceLabel,_that.currency,_that.duration,_that.durationMinutes,_that.imageUrl,_that.videoUrl,_that.isActive,_that.isFeatured,_that.isAvailable,_that.maxBookingsPerDay,_that.advanceNoticeDays,_that.sortOrder,_that.pricingTiers,_that.requirements,_that.cancellationPolicy,_that.createdAt,_that.updatedAt);case _:
  return null;
...
class _ServiceDetail implements ServiceDetail {
  const _ServiceDetail({required this.id, required this.name, required this.slug, this.description, this.shortDesc, this.price, this.priceLabel, this.currency = 'EUR', this.duration, this.durationMinutes, this.imageUrl, this.videoUrl, this.isActive = true, this.isFeatured = false, this.isAvailable = true, this.maxBookingsPerDay, this.advanceNoticeDays, this.sortOrder = 0, final  List<ServicePricingTierItem> pricingTiers = const [], this.requirements, this.cancellationPolicy, required this.createdAt, required this.updatedAt}): _pricingTiers = pricingTiers;
...
@override@JsonKey() final  int sortOrder;
 final  List<ServicePricingTierItem> _pricingTiers;
@override@JsonKey() List<ServicePricingTierItem> get pricingTiers {
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,name,slug,description,shortDesc,price,priceLabel,currency,duration,durationMinutes,imageUrl,videoUrl,isActive,isFeatured,isAvailable,maxBookingsPerDay,advanceNoticeDays,sortOrder,const DeepCollectionEquality().hash(_pricingTiers),requirements,cancellationPolicy,createdAt,updatedAt]);
