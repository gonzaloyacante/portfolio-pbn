...
_AboutSettings _$AboutSettingsFromJson(Map<String, dynamic> json) => _AboutSettings(
...
Map<String, dynamic> _$AboutSettingsToJson(_AboutSettings instance) => <String, dynamic>{
  'id': instance.id,
...
_ContactSettings _$ContactSettingsFromJson(Map<String, dynamic> json) => _ContactSettings(
  id: json['id'] as String?,
...
Map<String, dynamic> _$ContactSettingsToJson(_ContactSettings instance) => <String, dynamic>{
  'id': instance.id,
...
_ThemeSettings _$ThemeSettingsFromJson(Map<String, dynamic> json) => _ThemeSettings(
  id: json['id'] as String?,
...
Map<String, dynamic> _$ThemeSettingsToJson(_ThemeSettings instance) => <String, dynamic>{
  'id': instance.id,
...
_SiteSettings _$SiteSettingsFromJson(Map<String, dynamic> json) => _SiteSettings(
  id: json['id'] as String?,
  siteName: json['siteName'] as String? ?? 'Paola Bolívar Nievas - Make-up Artist',
...
Map<String, dynamic> _$SiteSettingsToJson(_SiteSettings instance) => <String, dynamic>{
  'id': instance.id,
...
Map<String, dynamic> _$SocialLinkToJson(_SocialLink instance) => <String, dynamic>{
  'id': instance.id,
