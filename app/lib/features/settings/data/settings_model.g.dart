...
_HomeSettings _$HomeSettingsFromJson(
  ...
  heroBackdropLoop: json['heroBackdropLoop'] as bool? ?? true,
  heroBackdropMuted: json['heroBackdropMuted'] as bool? ?? true,
  heroBackdropPlaysInline: json['heroBackdropPlaysInline'] as bool? ?? true,
  heroBackdropObjectFit: json['heroBackdropObjectFit'] as String? ?? 'cover',
  heroBackdropObjectPosition:
      json['heroBackdropObjectPosition'] as String? ?? 'center',
  heroBackdropMobileUrl: json['heroBackdropMobileUrl'] as String?,
  heroBackdropMobileObjectPosition:
      json['heroBackdropMobileObjectPosition'] as String?,
  heroForegroundPortraitShow:
      json['heroForegroundPortraitShow'] as bool? ?? true,
  heroScrimEdge: json['heroScrimEdge'] as String? ?? 'left',
  heroScrimExtentPercent:
      (json['heroScrimExtentPercent'] as num?)?.toInt() ?? 45,
  heroScrimOpacity: (json['heroScrimOpacity'] as num?)?.toInt() ?? 80,
  heroScrimColor: json['heroScrimColor'] as String?,
  heroScrimColorDark: json['heroScrimColorDark'] as String?,
  heroScrimFeatherPercent:
      (json['heroScrimFeatherPercent'] as num?)?.toInt() ?? 50,
  heroBackdropTintOpacity:
      (json['heroBackdropTintOpacity'] as num?)?.toInt() ?? 0,
  heroScrimMobileExtentPercent: (json['heroScrimMobileExtentPercent'] as num?)
      ?.toInt(),
  heroScrimMobileOpacity: (json['heroScrimMobileOpacity'] as num?)?.toInt(),
  illustrationUrl: json['illustrationUrl'] as String?,
  illustrationAlt: json['illustrationAlt'] as String?,
...
Map<String, dynamic> _$HomeSettingsToJson(
  _HomeSettings instance,
) => <String, dynamic>{
  'id': instance.id,
  ...
  'heroImmersiveEnabled': instance.heroImmersiveEnabled,
  'heroBackdropMediaKind': instance.heroBackdropMediaKind,
  'heroBackdropUrl': instance.heroBackdropUrl,
  'heroBackdropPosterUrl': instance.heroBackdropPosterUrl,
  'heroBackdropLoop': instance.heroBackdropLoop,
  'heroBackdropMuted': instance.heroBackdropMuted,
  'heroBackdropPlaysInline': instance.heroBackdropPlaysInline,
  'heroBackdropObjectFit': instance.heroBackdropObjectFit,
  'heroBackdropObjectPosition': instance.heroBackdropObjectPosition,
  'heroBackdropMobileUrl': instance.heroBackdropMobileUrl,
  'heroBackdropMobileObjectPosition': instance.heroBackdropMobileObjectPosition,
  'heroForegroundPortraitShow': instance.heroForegroundPortraitShow,
  'heroScrimEdge': instance.heroScrimEdge,
  'heroScrimExtentPercent': instance.heroScrimExtentPercent,
  'heroScrimOpacity': instance.heroScrimOpacity,
  'heroScrimColor': instance.heroScrimColor,
  'heroScrimColorDark': instance.heroScrimColorDark,
  'heroScrimFeatherPercent': instance.heroScrimFeatherPercent,
  'heroBackdropTintOpacity': instance.heroBackdropTintOpacity,
  'heroScrimMobileExtentPercent': instance.heroScrimMobileExtentPercent,
  'heroScrimMobileOpacity': instance.heroScrimMobileOpacity,
  'illustrationUrl': instance.illustrationUrl,
  'illustrationAlt': instance.illustrationAlt,
