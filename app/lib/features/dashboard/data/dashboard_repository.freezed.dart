...
mixin _$LocationStat {
  ...
  List<CityStat> get cities;

  /// Create a copy of LocationStat
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $LocationStatCopyWith<LocationStat> get copyWith =>
      _$LocationStatCopyWithImpl<LocationStat>(
          this as LocationStat, _$identity);
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, label, count, code, latitude,
      longitude, const DeepCollectionEquality().hash(cities));
...
abstract mixin class $LocationStatCopyWith<$Res> {
  factory $LocationStatCopyWith(
          LocationStat value, $Res Function(LocationStat) _then) =
      _$LocationStatCopyWithImpl;
  @useResult
  $Res call(
      {String label,
      int count,
...
/// @nodoc
class _$LocationStatCopyWithImpl<$Res> implements $LocationStatCopyWith<$Res> {
...
extension LocationStatPatterns on LocationStat {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_LocationStat value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String label, int count, String? code, double? latitude,
            double? longitude, List<CityStat> cities)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _LocationStat() when $default != null:
        return $default(_that.label, _that.count, _that.code, _that.latitude,
            _that.longitude, _that.cities);
      case _:
        return orElse();
    }
  }
...
class _LocationStat implements LocationStat {
  const _LocationStat(
      ...
      this.latitude,
      this.longitude,
      final List<CityStat> cities = const []})
      : _cities = cities;
  factory _LocationStat.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$LocationStatCopyWith<_LocationStat> get copyWith =>
      __$LocationStatCopyWithImpl<_LocationStat>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$LocationStatToJson(
      this,
    );
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, label, count, code, latitude,
      longitude, const DeepCollectionEquality().hash(_cities));
...
/// @nodoc
abstract mixin class _$LocationStatCopyWith<$Res>
    implements $LocationStatCopyWith<$Res> {
  factory _$LocationStatCopyWith(
          _LocationStat value, $Res Function(_LocationStat) _then) =
      __$LocationStatCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String label,
...
mixin _$CityStat {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $CityStatCopyWith<CityStat> get copyWith =>
      _$CityStatCopyWithImpl<CityStat>(this as CityStat, _$identity);
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, label, count, percent, latitude, longitude);
...
abstract mixin class $CityStatCopyWith<$Res> {
  factory $CityStatCopyWith(CityStat value, $Res Function(CityStat) _then) =
      _$CityStatCopyWithImpl;
  @useResult
  $Res call(
      {String label,
      int count,
...
/// @nodoc
class _$CityStatCopyWithImpl<$Res> implements $CityStatCopyWith<$Res> {
...
extension CityStatPatterns on CityStat {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_CityStat value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
  ...
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String label, int count, int percent, double? latitude,
            double? longitude)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _CityStat() when $default != null:
        return $default(_that.label, _that.count, _that.percent, _that.latitude,
            _that.longitude);
      case _:
        return orElse();
    }
...
class _CityStat implements CityStat {
  const _CityStat(
      ...
      this.latitude,
      this.longitude});
  factory _CityStat.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$CityStatCopyWith<_CityStat> get copyWith =>
      __$CityStatCopyWithImpl<_CityStat>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$CityStatToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$CityStatCopyWith<$Res>
    implements $CityStatCopyWith<$Res> {
  factory _$CityStatCopyWith(_CityStat value, $Res Function(_CityStat) _then) =
      __$CityStatCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String label,
...
/// @nodoc
class __$CityStatCopyWithImpl<$Res> implements _$CityStatCopyWith<$Res> {
...
mixin _$DashboardStats {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.totalTestimonials, totalTestimonials) ||
                other.totalTestimonials == totalTestimonials) &&
            (identical(other.newContacts, newContacts) ||
                other.newContacts == newContacts) &&
            (identical(other.pendingBookings, pendingBookings) ||
                other.pendingBookings == pendingBookings) &&
            (identical(other.pendingTestimonials, pendingTestimonials) ||
                other.pendingTestimonials == pendingTestimonials) &&
            (identical(other.trashCount, trashCount) ||
                other.trashCount == trashCount) &&
            (identical(other.pageViews30d, pageViews30d) ||
                other.pageViews30d == pageViews30d) &&
            (identical(other.uniqueVisitors30d, uniqueVisitors30d) ||
                other.uniqueVisitors30d == uniqueVisitors30d) &&
            const DeepCollectionEquality()
                .equals(other.deviceUsage, deviceUsage) &&
            const DeepCollectionEquality()
                .equals(other.topLocations, topLocations) &&
            const DeepCollectionEquality()
                .equals(other.topProjects, topProjects));
  }
  ...
  int get hashCode => Object.hash(
      ...
      pageViews30d,
      uniqueVisitors30d,
      const DeepCollectionEquality().hash(deviceUsage),
      const DeepCollectionEquality().hash(topLocations),
      const DeepCollectionEquality().hash(topProjects));
...
abstract mixin class $DashboardStatsCopyWith<$Res> {
  ...
  $Res call(
      ...
      List<ChartDataPoint> topProjects});
}
...
class _$DashboardStatsCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    Object? totalTestimonials = null,
    Object? newContacts = null,
    Object? pendingBookings = null,
    Object? pendingTestimonials = null,
    Object? trashCount = null,
    Object? pageViews30d = null,
    Object? uniqueVisitors30d = null,
    Object? deviceUsage = null,
    Object? topLocations = null,
    Object? topProjects = null,
  }) {
    return _then(_self.copyWith(
      ...
      totalServices: null == totalServices
          ...
          : totalServices // ignore: cast_nullable_to_non_nullable
              as int,
      totalTestimonials: null == totalTestimonials
          ? _self.totalTestimonials
          : totalTestimonials // ignore: cast_nullable_to_non_nullable
              as int,
      newContacts: null == newContacts
          ? _self.newContacts
          : newContacts // ignore: cast_nullable_to_non_nullable
              as int,
      pendingBookings: null == pendingBookings
          ? _self.pendingBookings
          : pendingBookings // ignore: cast_nullable_to_non_nullable
              as int,
      pendingTestimonials: null == pendingTestimonials
          ? _self.pendingTestimonials
          : pendingTestimonials // ignore: cast_nullable_to_non_nullable
              as int,
      trashCount: null == trashCount
          ? _self.trashCount
          : trashCount // ignore: cast_nullable_to_non_nullable
              as int,
      pageViews30d: null == pageViews30d
          ? _self.pageViews30d
          : pageViews30d // ignore: cast_nullable_to_non_nullable
              as int,
      uniqueVisitors30d: null == uniqueVisitors30d
          ? _self.uniqueVisitors30d
          : uniqueVisitors30d // ignore: cast_nullable_to_non_nullable
              as int,
      deviceUsage: null == deviceUsage
          ? _self.deviceUsage
          : deviceUsage // ignore: cast_nullable_to_non_nullable
              as Map<String, int>,
      topLocations: null == topLocations
          ? _self.topLocations
          : topLocations // ignore: cast_nullable_to_non_nullable
              as List<LocationStat>,
      topProjects: null == topProjects
          ? _self.topProjects
          : topProjects // ignore: cast_nullable_to_non_nullable
    ...
    switch (_that) {
      case _DashboardStats() when $default != null:
        return $default(
            ...
            _that.totalServices,
            _that.totalTestimonials,
            _that.newContacts,
            _that.pendingBookings,
            _that.pendingTestimonials,
            _that.trashCount,
            _that.pageViews30d,
            _that.uniqueVisitors30d,
            _that.deviceUsage,
            _that.topLocations,
            _that.topProjects);
      case _:
...
class _DashboardStats implements DashboardStats {
  const _DashboardStats(
      ...
      this.trashCount = 0,
      this.pageViews30d = 0,
      this.uniqueVisitors30d = 0,
      final Map<String, int> deviceUsage = const {},
      final List<LocationStat> topLocations = const [],
      final List<ChartDataPoint> topProjects = const []})
      : _deviceUsage = deviceUsage,
        _topLocations = topLocations,
        _topProjects = topProjects;
  ...
  @override
  @JsonKey()
  final int pageViews30d;

  /// Visitantes únicos (sesiones distintas, sin contar cada página que navegan).
  @override
  @JsonKey()
  final int uniqueVisitors30d;
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.uniqueVisitors30d, uniqueVisitors30d) ||
                other.uniqueVisitors30d == uniqueVisitors30d) &&
            const DeepCollectionEquality()
                .equals(other._deviceUsage, _deviceUsage) &&
            const DeepCollectionEquality()
                .equals(other._topLocations, _topLocations) &&
            const DeepCollectionEquality()
                .equals(other._topProjects, _topProjects));
  }
  ...
  int get hashCode => Object.hash(
      ...
      pageViews30d,
      uniqueVisitors30d,
      const DeepCollectionEquality().hash(_deviceUsage),
      const DeepCollectionEquality().hash(_topLocations),
      const DeepCollectionEquality().hash(_topProjects));
...
mixin _$ChartDataPoint {
  ...
  $ChartDataPointCopyWith<ChartDataPoint> get copyWith =>
      _$ChartDataPointCopyWithImpl<ChartDataPoint>(
          this as ChartDataPoint, _$identity);
...
abstract mixin class $ChartDataPointCopyWith<$Res> {
  factory $ChartDataPointCopyWith(
          ChartDataPoint value, $Res Function(ChartDataPoint) _then) =
      _$ChartDataPointCopyWithImpl;
  @useResult
...
extension ChartDataPointPatterns on ChartDataPoint {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ChartDataPoint value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
  ...
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String label, int count)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
...
class _ChartDataPoint implements ChartDataPoint {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ChartDataPointCopyWith<_ChartDataPoint> get copyWith =>
      __$ChartDataPointCopyWithImpl<_ChartDataPoint>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ChartDataPointToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$ChartDataPointCopyWith<$Res>
    implements $ChartDataPointCopyWith<$Res> {
  factory _$ChartDataPointCopyWith(
          _ChartDataPoint value, $Res Function(_ChartDataPoint) _then) =
      __$ChartDataPointCopyWithImpl;
  @override
  @useResult
  $Res call({String label, int count});
}
...
mixin _$DashboardCharts {
  List<ChartDataPoint> get dailyPageViews;
  List<ChartDataPoint> get monthlyBookings;

  /// Create a copy of DashboardCharts
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $DashboardChartsCopyWith<DashboardCharts> get copyWith =>
      _$DashboardChartsCopyWithImpl<DashboardCharts>(
          this as DashboardCharts, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is DashboardCharts &&
            const DeepCollectionEquality()
                .equals(other.dailyPageViews, dailyPageViews) &&
            const DeepCollectionEquality()
                .equals(other.monthlyBookings, monthlyBookings));
  }
  ...
  int get hashCode => Object.hash(
      runtimeType,
      const DeepCollectionEquality().hash(dailyPageViews),
      const DeepCollectionEquality().hash(monthlyBookings));
...
abstract mixin class $DashboardChartsCopyWith<$Res> {
  factory $DashboardChartsCopyWith(
          DashboardCharts value, $Res Function(DashboardCharts) _then) =
      _$DashboardChartsCopyWithImpl;
  @useResult
  $Res call(
      {List<ChartDataPoint> dailyPageViews,
      List<ChartDataPoint> monthlyBookings});
}
...
class _$DashboardChartsCopyWithImpl<$Res>
  ...
  @override
  $Res call({
    Object? dailyPageViews = null,
    Object? monthlyBookings = null,
  }) {
    return _then(_self.copyWith(
      dailyPageViews: null == dailyPageViews
          ? _self.dailyPageViews
          : dailyPageViews // ignore: cast_nullable_to_non_nullable
              as List<ChartDataPoint>,
...
extension DashboardChartsPatterns on DashboardCharts {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_DashboardCharts value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
  ...
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(List<ChartDataPoint> dailyPageViews,
            List<ChartDataPoint> monthlyBookings)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _DashboardCharts() when $default != null:
        return $default(_that.dailyPageViews, _that.monthlyBookings);
      case _:
        return orElse();
    }
  }
...
class _DashboardCharts implements DashboardCharts {
  const _DashboardCharts(
      {final List<ChartDataPoint> dailyPageViews = const [],
      final List<ChartDataPoint> monthlyBookings = const []})
      : _dailyPageViews = dailyPageViews,
        _monthlyBookings = monthlyBookings;
  factory _DashboardCharts.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$DashboardChartsCopyWith<_DashboardCharts> get copyWith =>
      __$DashboardChartsCopyWithImpl<_DashboardCharts>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$DashboardChartsToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _DashboardCharts &&
            const DeepCollectionEquality()
                .equals(other._dailyPageViews, _dailyPageViews) &&
            const DeepCollectionEquality()
                .equals(other._monthlyBookings, _monthlyBookings));
  }
  ...
  int get hashCode => Object.hash(
      runtimeType,
      const DeepCollectionEquality().hash(_dailyPageViews),
      const DeepCollectionEquality().hash(_monthlyBookings));
...
/// @nodoc
abstract mixin class _$DashboardChartsCopyWith<$Res>
    implements $DashboardChartsCopyWith<$Res> {
  factory _$DashboardChartsCopyWith(
          _DashboardCharts value, $Res Function(_DashboardCharts) _then) =
      __$DashboardChartsCopyWithImpl;
  @override
  @useResult
  $Res call(
      {List<ChartDataPoint> dailyPageViews,
...
class __$DashboardChartsCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_DashboardCharts(
      dailyPageViews: null == dailyPageViews
          ? _self._dailyPageViews
          : dailyPageViews // ignore: cast_nullable_to_non_nullable
              as List<ChartDataPoint>,
      monthlyBookings: null == monthlyBookings
          ? _self._monthlyBookings
          : monthlyBookings // ignore: cast_nullable_to_non_nullable
              as List<ChartDataPoint>,
    ));
  }
