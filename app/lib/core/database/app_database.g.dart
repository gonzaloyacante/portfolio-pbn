...
class $SyncOperationsTableTable extends SyncOperationsTable
  ...
  static const VerificationMeta _resourceMeta = const VerificationMeta('resource');
  @override
  ...
  static const VerificationMeta _resourceIdMeta = const VerificationMeta('resourceId');
  @override
  ...
  late final GeneratedColumn<bool> failed = GeneratedColumn<bool>(
    ...
    requiredDuringInsert: false,
    defaultConstraints: GeneratedColumn.constraintIsAlways('CHECK ("failed" IN (0, 1))'),
  ...
  @override
  VerificationContext validateIntegrity(Insertable<SyncOperationsTableData> instance, {bool isInserting = false}) {
    ...
    if (data.containsKey('resource')) {
      context.handle(_resourceMeta, resource.isAcceptableOrUnknown(data['resource']!, _resourceMeta));
    } else if (isInserting) {
      context.missing(_resourceMeta);
    }
    if (data.containsKey('resource_id')) {
      context.handle(_resourceIdMeta, resourceId.isAcceptableOrUnknown(data['resource_id']!, _resourceIdMeta));
    }
    ...
    if (data.containsKey('failed')) {
      context.handle(_failedMeta, failed.isAcceptableOrUnknown(data['failed']!, _failedMeta));
    }
  ...
  @override
  SyncOperationsTableData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return SyncOperationsTableData(
      ...
      resource: attachedDatabase.typeMapping.read(DriftSqlType.string, data['${effectivePrefix}resource'])!,
      resourceId: attachedDatabase.typeMapping.read(DriftSqlType.string, data['${effectivePrefix}resource_id']),
      ...
      failed: attachedDatabase.typeMapping.read(DriftSqlType.bool, data['${effectivePrefix}failed'])!,
...
class SyncOperationsTableData extends DataClass implements Insertable<SyncOperationsTableData> {
  ...
  SyncOperationsTableCompanion toCompanion(bool nullToAbsent) {
    return SyncOperationsTableCompanion(
      ...
      resourceId: resourceId == null && nullToAbsent ? const Value.absent() : Value(resourceId),
      payload: Value(payload),
      attempts: Value(attempts),
      failed: Value(failed),
      createdAt: Value(createdAt),
      lastAttemptAt: lastAttemptAt == null && nullToAbsent ? const Value.absent() : Value(lastAttemptAt),
    );
  }

  factory SyncOperationsTableData.fromJson(Map<String, dynamic> json, {ValueSerializer? serializer}) {
  ...
  SyncOperationsTableData copyWithCompanion(SyncOperationsTableCompanion data) {
    return SyncOperationsTableData(
      ...
      resourceId: data.resourceId.present ? data.resourceId.value : this.resourceId,
  ...
  @override
  int get hashCode =>
      Object.hash(id, operation, resource, resourceId, payload, attempts, failed, createdAt, lastAttemptAt);
  @override
...
class SyncOperationsTableCompanion extends UpdateCompanion<SyncOperationsTableData> {
...
class $CacheTableTable extends CacheTable with TableInfo<$CacheTableTable, CacheTableData> {
  ...
  @override
  List<GeneratedColumn> get $columns => [cacheKey, payload, expiresAt, updatedAt];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  ...
  @override
  VerificationContext validateIntegrity(Insertable<CacheTableData> instance, {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  CacheTableData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return CacheTableData(
      ...
      payload: attachedDatabase.typeMapping.read(DriftSqlType.string, data['${effectivePrefix}payload'])!,
      expiresAt: attachedDatabase.typeMapping.read(DriftSqlType.int, data['${effectivePrefix}expires_at'])!,
...
class CacheTableData extends DataClass implements Insertable<CacheTableData> {
  ...
  CacheTableData copyWith({String? cacheKey, String? payload, int? expiresAt, int? updatedAt}) => CacheTableData(
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final $SyncOperationsTableTable syncOperationsTable = $SyncOperationsTableTable(this);
  late final $CacheTableTable cacheTable = $CacheTableTable(this);
  @override
  Iterable<TableInfo<Table, Object?>> get allTables => allSchemaEntities.whereType<TableInfo<Table, Object?>>();
  @override
  List<DatabaseSchemaEntity> get allSchemaEntities => [syncOperationsTable, cacheTable];
}
...
class $$SyncOperationsTableTableFilterComposer extends Composer<_$AppDatabase, $SyncOperationsTableTable> {
  ...
  ColumnFilters<String> get resource =>
      $composableBuilder(column: $table.resource, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get resourceId =>
      $composableBuilder(column: $table.resourceId, builder: (column) => ColumnFilters(column));
  ...
  ColumnFilters<bool> get failed =>
      $composableBuilder(column: $table.failed, builder: (column) => ColumnFilters(column));
...
class $$SyncOperationsTableTableOrderingComposer extends Composer<_$AppDatabase, $SyncOperationsTableTable> {
  ...
  ColumnOrderings<String> get resource =>
      $composableBuilder(column: $table.resource, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get resourceId =>
      $composableBuilder(column: $table.resourceId, builder: (column) => ColumnOrderings(column));
  ...
  ColumnOrderings<bool> get failed =>
      $composableBuilder(column: $table.failed, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<DateTime> get createdAt =>
      $composableBuilder(column: $table.createdAt, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<DateTime> get lastAttemptAt =>
      $composableBuilder(column: $table.lastAttemptAt, builder: (column) => ColumnOrderings(column));
}

class $$SyncOperationsTableTableAnnotationComposer extends Composer<_$AppDatabase, $SyncOperationsTableTable> {
  ...
  GeneratedColumn<String> get resource => $composableBuilder(column: $table.resource, builder: (column) => column);

  GeneratedColumn<String> get resourceId => $composableBuilder(column: $table.resourceId, builder: (column) => column);
  ...
  GeneratedColumn<bool> get failed => $composableBuilder(column: $table.failed, builder: (column) => column);
...
class $$SyncOperationsTableTableTableManager
    extends
        RootTableManager<
          ...
          (SyncOperationsTableData, BaseReferences<_$AppDatabase, $SyncOperationsTableTable, SyncOperationsTableData>),
          SyncOperationsTableData,
          PrefetchHooks Function()
        > {
  $$SyncOperationsTableTableTableManager(_$AppDatabase db, $SyncOperationsTableTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () => $$SyncOperationsTableTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () => $$SyncOperationsTableTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () => $$SyncOperationsTableTableAnnotationComposer($db: db, $table: table),
...
class $$CacheTableTableFilterComposer extends Composer<_$AppDatabase, $CacheTableTable> {
...
class $$CacheTableTableOrderingComposer extends Composer<_$AppDatabase, $CacheTableTable> {
...
class $$CacheTableTableAnnotationComposer extends Composer<_$AppDatabase, $CacheTableTable> {
  ...
  GeneratedColumn<int> get expiresAt => $composableBuilder(column: $table.expiresAt, builder: (column) => column);
...
class $$CacheTableTableTableManager
    extends
        RootTableManager<
          ...
          (CacheTableData, BaseReferences<_$AppDatabase, $CacheTableTable, CacheTableData>),
          CacheTableData,
          PrefetchHooks Function()
        > {
  $$CacheTableTableTableManager(_$AppDatabase db, $CacheTableTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () => $$CacheTableTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () => $$CacheTableTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () => $$CacheTableTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
...
class $AppDatabaseManager {
  ...
  $$CacheTableTableTableManager get cacheTable => $$CacheTableTableTableManager(_db, _db.cacheTable);
}
