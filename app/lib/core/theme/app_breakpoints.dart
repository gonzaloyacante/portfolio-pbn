...
abstract final class AppBreakpoints {
  ...
  static bool isCompact(BuildContext context) => MediaQuery.sizeOf(context).width < _compact;
  ...
  static bool isExpanded(BuildContext context) => MediaQuery.sizeOf(context).width >= _expanded;

  static bool isMobile(BuildContext context) => MediaQuery.sizeOf(context).width < _compact;

  static bool isTablet(BuildContext context) => MediaQuery.sizeOf(context).width >= _compact;

  // ── Helpers de valor por breakpoint ─────────────────────────────────────

  /// Devuelve un valor tipado según el breakpoint actual.
  static T value<T>(BuildContext context, {required T compact, required T medium, required T expanded}) {
    final w = MediaQuery.sizeOf(context).width;
  ...
  static double pageMargin(BuildContext context) => value(context, compact: 16, medium: 24, expanded: 24);

  /// Gutter entre elementos de grid.
  static double gutter(BuildContext context) => value(context, compact: 12, medium: 16, expanded: 20);
  ...
  static EdgeInsets horizontalPadding(BuildContext context) => EdgeInsets.symmetric(horizontal: pageMargin(context));
  ...
  static bool isMobileLandscape(BuildContext context) {
    ...
    return size.width >= _compact && size.height < _compact && isLandscape(context);
  }
}
