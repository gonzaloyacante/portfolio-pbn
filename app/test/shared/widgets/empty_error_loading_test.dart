...
void main() {
  ...
  group('EmptyState — renders', () {
    testWidgets('shows title', (tester) async {
      await tester.pumpWidget(
        _wrap(const EmptyState(icon: Icons.inbox, title: 'Nothing here')),
      );
    ...
    testWidgets('shows icon', (tester) async {
      await tester.pumpWidget(
        _wrap(const EmptyState(icon: Icons.inbox, title: 'Empty')),
      );
  ...
  group('ErrorState — renders', () {
    testWidgets('shows error message', (tester) async {
      await tester.pumpWidget(
        _wrap(const ErrorState(message: 'An error occurred')),
      );
    ...
    testWidgets('shows retry button when onRetry provided', (tester) async {
      await tester.pumpWidget(
        _wrap(ErrorState(message: 'Fail', onRetry: () {})),
      );
    ...
    testWidgets('retry fires callback', (tester) async {
      bool retried = false;
      await tester.pumpWidget(
        _wrap(ErrorState(message: 'Fail', onRetry: () => retried = true)),
      );
  ...
  group('LoadingOverlay — renders', () {
    ...
    testWidgets('no CircularProgressIndicator when not loading', (
      tester,
    ) async {
      await tester.pumpWidget(
  ...
  group('StatusBadge — extended statuses', () {
    ...
    testWidgets('confirmed renders', (tester) async {
      await tester.pumpWidget(
        _wrap(const StatusBadge(status: AppStatus.confirmed)),
      );
      expect(find.byType(StatusBadge), findsOneWidget);
    });
    ...
    testWidgets('custom label overrides default', (tester) async {
      await tester.pumpWidget(
        _wrap(
          const StatusBadge(status: AppStatus.pending, label: 'En revisión'),
        ),
      );
