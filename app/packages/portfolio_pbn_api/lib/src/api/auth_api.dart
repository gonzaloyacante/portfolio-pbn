...
class AuthApi {
  ...
  Future<Response<AdminProfile>> adminGetMe({ 
    ...
    final _path = r'/api/admin/auth/me';
...
_responseData = rawData == null ? null : deserialize<AdminProfile, AdminProfile>(rawData, 'AdminProfile', growable: true);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<LoginResponse>> adminLogin({ 
    ...
    final _path = r'/api/admin/auth/login';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
...
_responseData = rawData == null ? null : deserialize<LoginResponse, LoginResponse>(rawData, 'LoginResponse', growable: true);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<LogoutResponse>> adminLogout({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/admin/auth/logout';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<LogoutResponse, LogoutResponse>(rawData, 'LogoutResponse', growable: true);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<RefreshResponse>> adminRefreshToken({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/admin/auth/refresh';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<RefreshResponse, RefreshResponse>(rawData, 'RefreshResponse', growable: true);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [UpdateMeResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UpdateMeResponse>> adminUpdateMe({ 
...
_bodyData=jsonEncode(updateMeRequest);
    ...
    UpdateMeResponse? _responseData;

    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<UpdateMeResponse, UpdateMeResponse>(rawData, 'UpdateMeResponse', growable: true);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<UpdateMeResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
